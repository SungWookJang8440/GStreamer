...
int main(int argc, char *argv[]) {
    AppData app_data = {NULL, NULL, 0, 0, 0, FALSE, "C:\\Users\\장성욱\\Desktop\\ws\\Gstreamer\\Output_Image", 0, NULL, 0, 0, FALSE};
    ...
    //비디오 파일 위치 관련
    g_object_set(G_OBJECT(source), "location", "C:\\Users\\장성욱\\Desktop\\Soccernet data\\Tackle\\Tackle6.mp4", NULL);
